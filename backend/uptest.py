...
def get_shell(host_alias="redtapi2") -> SshShell:
    ...
    sh = spurplus.connect_with_retries(
        ...
        username='ubuntu',
        private_key_file='C:/Users/hesus/Programming/telsiusin2/awsnode/AWSAlastriaIN2.pem',
        retries=5,
        connect_timeout=5,
        )
    return sh
...
def update_frontend_test(sh: SshShell):

    local_dir = "statictest"
    remote_dir = "/home/ubuntu/backend/statictest"

    print("=== Compare TEST frontend files before synchronization")
    print("======================================================")
    ...
    print("Synchronize TEST frontend files")
